...
execute if entity @a[distance=..20,gamemode=!spectator] unless entity @e[tag=airlock-button,distance=..10] run function arc86:airlock/summon_buttons
...
execute unless entity @a[distance=..20,gamemode=!spectator] run kill @e[tag=airlock-button,distance=..10]
