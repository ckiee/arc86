...
# reload
execute if score @s gunAmmo matches 0 if data entity @s SelectedItem.tag.rifle run execute store result score $RL gunAmmo run clear @s netherite_ingot 1
execute if score @s gunAmmo matches 0 if data entity @s SelectedItem.tag.pistol run execute store result score $RL gunAmmo run clear @s netherite_scrap 1
