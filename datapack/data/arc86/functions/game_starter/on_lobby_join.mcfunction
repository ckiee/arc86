...
tellraw @s [{"color":"gold","text":"First things first, however, you’ll need to be acquainted with the basics of gameplay. If you have the texture pack applied, you should see a keycard in your inventory right about now. Turn around, and right click the reader to open the door; your tutorial starts there. Good luck, and have fun!","bold":false}]
gamemode adventure
