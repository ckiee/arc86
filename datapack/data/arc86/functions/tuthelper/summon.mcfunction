...
summon minecraft:item_frame -111 152 79 {Facing:2b, Fixed:1b, Invisible:1b, Invulnerable:1b, Item:{Count:1b, id:"minecraft:carrot_on_a_stick", tag: {CustomModelData:905001}}, Tags: [s1-frame, s1-framea]}
summon minecraft:item_frame -107 154 79 {Facing:2b, Fixed:1b, Invisible:1b, Invulnerable:1b, Item:{Count:1b, id:"minecraft:carrot_on_a_stick", tag: {CustomModelData:905002}}, Tags: [s1-frame, s1-frameb]}
