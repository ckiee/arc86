...
execute if score $hit raycast matches 0 if entity @e[tag=keycard-reader,distance=..2] run function arc86:keycard/hit
execute if entity @e[tag=!ray,distance=..2] run scoreboard players set $hit raycast 1
