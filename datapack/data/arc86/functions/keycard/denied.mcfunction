...
execute if score $check_eq keycard matches 1 if score $required keycard matches 1 run title @s actionbar ["",{"text":"Access Denied (keyed to ","color":"red"},{"text":"ANAND, A.","color":"dark_red"},{"text":")","color":"red"}]
