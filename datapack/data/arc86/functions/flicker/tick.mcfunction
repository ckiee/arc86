...
execute if score $flickering flickerTime matches 1 run execute as @e[tag=flicker-lamp] run execute at @s if entity @a[distance=..50] run function arc86:flicker/lamp_tick
